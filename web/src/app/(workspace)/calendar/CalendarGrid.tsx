    ...
    <div>
        ...
        {cells.map((day, i) => {
          ...
          return (
            ...
            >
              ...
              {taskCount > 0 && (
                <span className="status-pop rounded-full border border-transparent bg-blue-400/15 px-2 py-0.5 text-xs font-medium text-blue-300">
      ...
      >
        ...
        <button
          ...
          className="btn btn-sm btn-glow mt-3 w-full"
        >
          Close
        </button>
      </dialog>
